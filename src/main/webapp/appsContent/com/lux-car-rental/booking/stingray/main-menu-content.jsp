...
<sb:component componentId="6">
				...
				<div class="component" data-component-type="bs-form" ${componentIdAttribute}>
					<form class="component-container" action="${fn:escapeXml(componentProps.action)}" method="${componentProps.method}" data-component-id="7">
...
<div class="component script-container" data-component-type="sling-include" data-component-id="13">
